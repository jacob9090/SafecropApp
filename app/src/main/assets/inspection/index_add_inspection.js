...
function populateSurveyFields(farmer_id, farmer_name, district, community, ghana_card, farmer_yob, farmer_phone, farmer_gender) {
    ...
    survey.setValue('farmer_phone', farmer_phone);
    survey.setValue('farmer_gender', farmer_gender);
}
...
function saveInspection(isDraft) {
    ...
    Android.insertOrUpdateInspection(
        ...
        data.inspection_question59b || "",
        data.inspection_question60 || "",
        data.inspection_question60b || "",
        data.inspection_question61 || "",
        data.inspection_question61b || "",
        data.inspection_question62 || "",
        data.inspection_question62b || "",
        data.inspection_question63 || "",
        data.inspection_question63b || "",
