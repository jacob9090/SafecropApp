...
public class SchoolSurveyCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_survey_completed);
        ...
        newSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nsintent = new Intent(SchoolSurveyCompletedActivity.this, SchoolWebSurveyActivity.class);
        ...
        homeSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent dintent = new Intent(SchoolSurveyCompletedActivity.this, ComDevDashboard.class);
