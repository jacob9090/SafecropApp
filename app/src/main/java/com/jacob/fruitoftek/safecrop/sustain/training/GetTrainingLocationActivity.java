...
public class GetTrainingLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_training_location);
        ...
        locationTextView = findViewById(R.id.trainingLocationTextView);
        captureButton = findViewById(R.id.trainingCaptureSchLocationButton);
        okButton = findViewById(R.id.trainingOkButton);
        loadingIndicator = findViewById(R.id.trainingLoadingIndicator);
    ...
    private void initializeMap() {
        mapView = findViewById(R.id.trainingMapView);
        if (mapView == null) {
