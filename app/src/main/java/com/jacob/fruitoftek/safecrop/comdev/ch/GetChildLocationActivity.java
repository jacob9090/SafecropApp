...
public class GetChildLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_child_location);
        ...
        locationTextView = findViewById(R.id.chLocationTextView);
        captureButton = findViewById(R.id.chCaptureSchLocationButton);
        okButton = findViewById(R.id.chOkButton);
        loadingIndicator = findViewById(R.id.chLoadingIndicator);
    ...
    private void initializeMap() {
        mapView = findViewById(R.id.chMapView);
        if (mapView == null) {
