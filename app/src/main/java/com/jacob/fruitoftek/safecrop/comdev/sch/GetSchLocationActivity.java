...
public class GetSchLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_sch_location);
        ...
        locationTextView = findViewById(R.id.schLocationTextView);
        captureButton = findViewById(R.id.schCaptureSchLocationButton);
        okButton = findViewById(R.id.schOkButton);
        loadingIndicator = findViewById(R.id.schLoadingIndicator);
