...
public class GetCraLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_cra_location);
        ...
        locationTextView = findViewById(R.id.craLocationTextView);
        captureButton = findViewById(R.id.craCaptureLocationButton);
        okButton = findViewById(R.id.craOkButton);
        loadingIndicator = findViewById(R.id.craLoadingIndicator);
