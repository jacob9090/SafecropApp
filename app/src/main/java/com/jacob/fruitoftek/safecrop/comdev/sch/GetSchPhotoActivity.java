...
public class GetSchPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_sch_photo);
        ...
        imageView = findViewById(R.id.schImageView);
        Button btnCaptureOrSelect = findViewById(R.id.schBtnCaptureOrSelect);
        Button btnOk = findViewById(R.id.schBtnOk);
