...
public class InspectionDetailsActivity extends AppCompatActivity {
    ...
    private void injectSurveyDetails() {
        ...
        String js = String.format("javascript:" +
                        ...
                        "document.getElementById('farmer_phone').textContent = '%s';" +
                        ...
                        "document.getElementById('inspection_question1b').textContent = '%s';" +
                        "document.getElementById('inspection_question2').textContent = '%s';" +
                        "document.getElementById('inspection_question2b').textContent = '%s';" +
                        "document.getElementById('inspection_question3').textContent = '%s';" +
                        "document.getElementById('inspection_question3b').textContent = '%s';" +
                        "document.getElementById('inspection_question4').textContent = '%s';" +
                        "document.getElementById('inspection_question4b').textContent = '%s';" +
                        "document.getElementById('inspection_question5').textContent = '%s';" +
                        "document.getElementById('inspection_question5b').textContent = '%s';" +
                        "document.getElementById('inspection_question6').textContent = '%s';" +
                        "document.getElementById('inspection_question6b').textContent = '%s';" +
                        "document.getElementById('inspection_question7').textContent = '%s';" +
                        "document.getElementById('inspection_question7b').textContent = '%s';" +
                        "document.getElementById('inspection_question8').textContent = '%s';" +
                        "document.getElementById('inspection_question8b').textContent = '%s';" +
                        "document.getElementById('inspection_question9').textContent = '%s';" +
                        "document.getElementById('inspection_question9b').textContent = '%s';" +
                        "document.getElementById('inspection_question10').textContent = '%s';" +
                        "document.getElementById('inspection_question10b').textContent = '%s';" +
                        "document.getElementById('inspection_question11').textContent = '%s';" +
                        "document.getElementById('inspection_question11b').textContent = '%s';" +
                        "document.getElementById('inspection_question12').textContent = '%s';" +
                        "document.getElementById('inspection_question12b').textContent = '%s';" +
                        "document.getElementById('inspection_question13').textContent = '%s';" +
                        "document.getElementById('inspection_question13b').textContent = '%s';" +
                        "document.getElementById('inspection_question14').textContent = '%s';" +
                        "document.getElementById('inspection_question14b').textContent = '%s';" +
                        "document.getElementById('inspection_question15').textContent = '%s';" +
                        "document.getElementById('inspection_question15b').textContent = '%s';" +
                        "document.getElementById('inspection_question16').textContent = '%s';" +
                        "document.getElementById('inspection_question16b').textContent = '%s';" +
                        "document.getElementById('inspection_question17').textContent = '%s';" +
                        "document.getElementById('inspection_question17b').textContent = '%s';" +
                        "document.getElementById('inspection_question18').textContent = '%s';" +
                        "document.getElementById('inspection_question18b').textContent = '%s';" +
                        "document.getElementById('inspection_question19').textContent = '%s';" +
                        "document.getElementById('inspection_question19b').textContent = '%s';" +
                        "document.getElementById('inspection_question20').textContent = '%s';" +
                        "document.getElementById('inspection_question20b').textContent = '%s';" +
                        "document.getElementById('inspection_question21').textContent = '%s';" +
                        "document.getElementById('inspection_question21b').textContent = '%s';" +
                        "document.getElementById('inspection_question22').textContent = '%s';" +
                        "document.getElementById('inspection_question22b').textContent = '%s';" +
                        "document.getElementById('inspection_question23').textContent = '%s';" +
                        "document.getElementById('inspection_question23b').textContent = '%s';" +
                        "document.getElementById('inspection_question24').textContent = '%s';" +
                        "document.getElementById('inspection_question24b').textContent = '%s';" +
                        "document.getElementById('inspection_question25').textContent = '%s';" +
                        "document.getElementById('inspection_question25b').textContent = '%s';" +
                        "document.getElementById('inspection_question26').textContent = '%s';" +
                        "document.getElementById('inspection_question26b').textContent = '%s';" +
                        "document.getElementById('inspection_question27').textContent = '%s';" +
                        "document.getElementById('inspection_question27b').textContent = '%s';" +
                        "document.getElementById('inspection_question28').textContent = '%s';" +
                        "document.getElementById('inspection_question28b').textContent = '%s';" +
                        "document.getElementById('inspection_question29').textContent = '%s';" +
                        "document.getElementById('inspection_question29b').textContent = '%s';" +
                        "document.getElementById('inspection_question30').textContent = '%s';" +
                        "document.getElementById('inspection_question30b').textContent = '%s';" +
                        "document.getElementById('inspection_question31').textContent = '%s';" +
                        "document.getElementById('inspection_question31b').textContent = '%s';" +
                        "document.getElementById('inspection_question32').textContent = '%s';" +
                        "document.getElementById('inspection_question32b').textContent = '%s';" +
                        "document.getElementById('inspection_question33').textContent = '%s';" +
                        "document.getElementById('inspection_question33b').textContent = '%s';" +
                        "document.getElementById('inspection_question34').textContent = '%s';" +
                        "document.getElementById('inspection_question34b').textContent = '%s';" +
                        "document.getElementById('inspection_question35').textContent = '%s';" +
                        "document.getElementById('inspection_question35b').textContent = '%s';" +
                        "document.getElementById('inspection_question36').textContent = '%s';" +
                        "document.getElementById('inspection_question36b').textContent = '%s';" +
                        "document.getElementById('inspection_question37').textContent = '%s';" +
                        "document.getElementById('inspection_question37b').textContent = '%s';" +
                        "document.getElementById('inspection_question38').textContent = '%s';" +
                        "document.getElementById('inspection_question38b').textContent = '%s';" +
                        "document.getElementById('inspection_question39').textContent = '%s';" +
                        "document.getElementById('inspection_question39b').textContent = '%s';" +
                        "document.getElementById('inspection_question40').textContent = '%s';" +
                        "document.getElementById('inspection_question40b').textContent = '%s';" +
                        "document.getElementById('inspection_question41').textContent = '%s';" +
                        "document.getElementById('inspection_question41b').textContent = '%s';" +
                        "document.getElementById('inspection_question42').textContent = '%s';" +
                        "document.getElementById('inspection_question42b').textContent = '%s';" +
                        "document.getElementById('inspection_question43').textContent = '%s';" +
                        "document.getElementById('inspection_question43b').textContent = '%s';" +
                        "document.getElementById('inspection_question44').textContent = '%s';" +
                        "document.getElementById('inspection_question44b').textContent = '%s';" +
                        "document.getElementById('inspection_question45').textContent = '%s';" +
                        "document.getElementById('inspection_question45b').textContent = '%s';" +
                        "document.getElementById('inspection_question46').textContent = '%s';" +
                        "document.getElementById('inspection_question46b').textContent = '%s';" +
                        "document.getElementById('inspection_question47').textContent = '%s';" +
                        "document.getElementById('inspection_question47b').textContent = '%s';" +
                        "document.getElementById('inspection_question48').textContent = '%s';" +
                        "document.getElementById('inspection_question48b').textContent = '%s';" +
                        "document.getElementById('inspection_question49').textContent = '%s';" +
                        "document.getElementById('inspection_question49b').textContent = '%s';" +
                        "document.getElementById('inspection_question50').textContent = '%s';" +
                        "document.getElementById('inspection_question50b').textContent = '%s';" +
                        "document.getElementById('inspection_question51').textContent = '%s';" +
                        "document.getElementById('inspection_question51b').textContent = '%s';" +
                        "document.getElementById('inspection_question52').textContent = '%s';" +
                        "document.getElementById('inspection_question52b').textContent = '%s';" +
                        "document.getElementById('inspection_question53').textContent = '%s';" +
                        "document.getElementById('inspection_question53b').textContent = '%s';" +
                        "document.getElementById('inspection_question54').textContent = '%s';" +
                        "document.getElementById('inspection_question54b').textContent = '%s';" +
                        "document.getElementById('inspection_question55').textContent = '%s';" +
                        "document.getElementById('inspection_question55b').textContent = '%s';" +
                        "document.getElementById('inspection_question56').textContent = '%s';" +
                        "document.getElementById('inspection_question56b').textContent = '%s';" +
                ...
                sanitize(inspectionModel.getFarmer_phone()),
                sanitize(inspectionModel.getFarmer_gender()),
                ...
                sanitize(inspectionModel.getInspection_question1b()),
                sanitize(inspectionModel.getInspection_question2()),
                sanitize(inspectionModel.getInspection_question2b()),
                sanitize(inspectionModel.getInspection_question3()),
                sanitize(inspectionModel.getInspection_question3b()),
                sanitize(inspectionModel.getInspection_question4()),
                sanitize(inspectionModel.getInspection_question4b()),
                sanitize(inspectionModel.getInspection_question5()),
                sanitize(inspectionModel.getInspection_question5b()),
                sanitize(inspectionModel.getInspection_question6()),
                sanitize(inspectionModel.getInspection_question6b()),
                sanitize(inspectionModel.getInspection_question7()),
                sanitize(inspectionModel.getInspection_question7b()),
                sanitize(inspectionModel.getInspection_question8()),
                sanitize(inspectionModel.getInspection_question8b()),
                sanitize(inspectionModel.getInspection_question9()),
                sanitize(inspectionModel.getInspection_question9b()),
                sanitize(inspectionModel.getInspection_question10()),
                sanitize(inspectionModel.getInspection_question10b()),
                sanitize(inspectionModel.getInspection_question11()),
                sanitize(inspectionModel.getInspection_question11b()),
                sanitize(inspectionModel.getInspection_question12()),
                sanitize(inspectionModel.getInspection_question12b()),
                sanitize(inspectionModel.getInspection_question13()),
                sanitize(inspectionModel.getInspection_question13b()),
                sanitize(inspectionModel.getInspection_question14()),
                sanitize(inspectionModel.getInspection_question14b()),
                sanitize(inspectionModel.getInspection_question15()),
                sanitize(inspectionModel.getInspection_question15b()),
                sanitize(inspectionModel.getInspection_question16()),
                sanitize(inspectionModel.getInspection_question16b()),
                sanitize(inspectionModel.getInspection_question17()),
                sanitize(inspectionModel.getInspection_question17b()),
                sanitize(inspectionModel.getInspection_question18()),
                sanitize(inspectionModel.getInspection_question18b()),
                sanitize(inspectionModel.getInspection_question19()),
                sanitize(inspectionModel.getInspection_question19b()),
                sanitize(inspectionModel.getInspection_question20()),
                sanitize(inspectionModel.getInspection_question20b()),
                sanitize(inspectionModel.getInspection_question21()),
                sanitize(inspectionModel.getInspection_question21b()),
                sanitize(inspectionModel.getInspection_question22()),
                sanitize(inspectionModel.getInspection_question22b()),
                sanitize(inspectionModel.getInspection_question23()),
                sanitize(inspectionModel.getInspection_question23b()),
                sanitize(inspectionModel.getInspection_question24()),
                sanitize(inspectionModel.getInspection_question24b()),
                sanitize(inspectionModel.getInspection_question25()),
                sanitize(inspectionModel.getInspection_question25b()),
                sanitize(inspectionModel.getInspection_question26()),
                sanitize(inspectionModel.getInspection_question26b()),
                sanitize(inspectionModel.getInspection_question27()),
                sanitize(inspectionModel.getInspection_question27b()),
                sanitize(inspectionModel.getInspection_question28()),
                sanitize(inspectionModel.getInspection_question28b()),
                sanitize(inspectionModel.getInspection_question29()),
                sanitize(inspectionModel.getInspection_question29b()),
                sanitize(inspectionModel.getInspection_question30()),
                sanitize(inspectionModel.getInspection_question30b()),
                sanitize(inspectionModel.getInspection_question31()),
                sanitize(inspectionModel.getInspection_question31b()),
                sanitize(inspectionModel.getInspection_question32()),
                sanitize(inspectionModel.getInspection_question32b()),
                sanitize(inspectionModel.getInspection_question33()),
                sanitize(inspectionModel.getInspection_question33b()),
                sanitize(inspectionModel.getInspection_question34()),
                sanitize(inspectionModel.getInspection_question34b()),
                sanitize(inspectionModel.getInspection_question35()),
                sanitize(inspectionModel.getInspection_question35b()),
                sanitize(inspectionModel.getInspection_question36()),
                sanitize(inspectionModel.getInspection_question36b()),
                sanitize(inspectionModel.getInspection_question37()),
                sanitize(inspectionModel.getInspection_question37b()),
                sanitize(inspectionModel.getInspection_question38()),
                sanitize(inspectionModel.getInspection_question38b()),
                sanitize(inspectionModel.getInspection_question39()),
                sanitize(inspectionModel.getInspection_question39b()),
                sanitize(inspectionModel.getInspection_question40()),
                sanitize(inspectionModel.getInspection_question40b()),
                sanitize(inspectionModel.getInspection_question41()),
                sanitize(inspectionModel.getInspection_question41b()),
                sanitize(inspectionModel.getInspection_question42()),
                sanitize(inspectionModel.getInspection_question42b()),
                sanitize(inspectionModel.getInspection_question43()),
                sanitize(inspectionModel.getInspection_question43b()),
                sanitize(inspectionModel.getInspection_question44()),
                sanitize(inspectionModel.getInspection_question44b()),
                sanitize(inspectionModel.getInspection_question45()),
                sanitize(inspectionModel.getInspection_question45b()),
                sanitize(inspectionModel.getInspection_question46()),
                sanitize(inspectionModel.getInspection_question46b()),
                sanitize(inspectionModel.getInspection_question47()),
                sanitize(inspectionModel.getInspection_question47b()),
                sanitize(inspectionModel.getInspection_question48()),
                sanitize(inspectionModel.getInspection_question48b()),
                sanitize(inspectionModel.getInspection_question49()),
                sanitize(inspectionModel.getInspection_question49b()),
                sanitize(inspectionModel.getInspection_question50()),
                sanitize(inspectionModel.getInspection_question50b()),
                sanitize(inspectionModel.getInspection_question51()),
                sanitize(inspectionModel.getInspection_question51b()),
                sanitize(inspectionModel.getInspection_question52()),
                sanitize(inspectionModel.getInspection_question52b()),
                sanitize(inspectionModel.getInspection_question53()),
                sanitize(inspectionModel.getInspection_question53b()),
                sanitize(inspectionModel.getInspection_question54()),
                sanitize(inspectionModel.getInspection_question54b()),
                sanitize(inspectionModel.getInspection_question55()),
                sanitize(inspectionModel.getInspection_question55b()),
                sanitize(inspectionModel.getInspection_question56()),
                sanitize(inspectionModel.getInspection_question56b()),
