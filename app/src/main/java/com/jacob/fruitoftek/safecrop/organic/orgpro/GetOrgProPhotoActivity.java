...
public class GetOrgProPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_org_pro_photo);
        ...
        imageView = findViewById(R.id.orgProschImageView);
        Button btnCaptureOrSelect = findViewById(R.id.orgProschBtnCaptureOrSelect);
        Button btnOk = findViewById(R.id.orgProschBtnOk);
