...
public class GMRDbHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_LNAME = "user_lname";
    ...
    public boolean insertSurveyData(String fname, String lname,
    ...
    public GMRModel getSurveyDetailsByFarmerCode(String gmrquestion5) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            gmrModel = new GMRModel(fname, lname, gmrquestion1, gmrquestion2, gmrquestion3, gmrquestion4,
