...
class GpsTrackerFIIS extends Service implements LocationListener {
    ...
    public GpsTrackerFIIS(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(GpsTrackerFIIS.this);
        }
    }
