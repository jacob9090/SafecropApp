...
public class CraSurveyCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cra_survey_completed);
        ...
        newSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nsintent = new Intent(CraSurveyCompletedActivity.this, CommunityRiskAssceActivity.class);
        ...
        homeSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent dintent = new Intent(CraSurveyCompletedActivity.this, ComDevDashboard.class);
