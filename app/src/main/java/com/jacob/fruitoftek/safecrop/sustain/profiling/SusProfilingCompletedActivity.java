...
public class SusProfilingCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sus_profiling_completed);
        ...
        newSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nsintent = new Intent(SusProfilingCompletedActivity.this, SusProfilingActivity.class);
        ...
        homeSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent dintent = new Intent(SusProfilingCompletedActivity.this, SusCertDashboard.class);
