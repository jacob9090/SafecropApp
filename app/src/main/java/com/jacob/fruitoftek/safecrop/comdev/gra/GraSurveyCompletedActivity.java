...
public class GraSurveyCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gra_survey_completed);
        ...
        newSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nsintent = new Intent(GraSurveyCompletedActivity.this, GraActivity.class);
        ...
        homeSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent dintent = new Intent(GraSurveyCompletedActivity.this, ComDevDashboard.class);
