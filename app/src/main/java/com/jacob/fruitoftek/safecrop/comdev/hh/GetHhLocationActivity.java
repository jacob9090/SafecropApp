...
public class GetHhLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_hh_location);
        ...
        locationTextView = findViewById(R.id.hhLocationTextView);
        captureButton = findViewById(R.id.hhCaptureSchLocationButton);
        okButton = findViewById(R.id.hhOkButton);
        loadingIndicator = findViewById(R.id.hhLoadingIndicator);
    ...
    private void initializeMap() {
        mapView = findViewById(R.id.hhMapView);
        if (mapView == null) {
