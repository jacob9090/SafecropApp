...
public class ChildSurveyCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_survey_completed);
        ...
        newSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nsintent = new Intent(ChildSurveyCompletedActivity.this, ChildWebListFarmersActivity.class);
        ...
        homeSuvBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent dintent = new Intent(ChildSurveyCompletedActivity.this, ComDevDashboard.class);
