...
import com.jacob.fruitoftek.safecrop.comdev.sch.SchoolSurveyCompletedActivity;
...
public class ChildForceLaborRiskAssceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schSurveyWebView = findViewById(R.id.cflraWebView);
        schProgressBar = findViewById(R.id.cflraProgressBar);

        schSurveyWebView.getSettings().setJavaScriptEnabled(true);
        schSurveyWebView.addJavascriptInterface(new ChildForceLaborRiskAssceActivity.WebAppInterface(this), "Android");
        ...
        schSurveyWebView.loadUrl("file:///android_asset/clflra/add_clflra.html");
