...
public class GetSusProfilingLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_sus_profiling_location);
        ...
        locationTextView = findViewById(R.id.susprofilingLocationTextView);
        captureButton = findViewById(R.id.susprofilingCaptureSchLocationButton);
        okButton = findViewById(R.id.susprofilingOkButton);
        loadingIndicator = findViewById(R.id.susprofilingLoadingIndicator);
    ...
    private void initializeMap() {
        mapView = findViewById(R.id.susprofilingMapView);
        if (mapView == null) {
