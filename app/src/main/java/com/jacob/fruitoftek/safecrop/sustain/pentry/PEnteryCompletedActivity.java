...
public class PEnteryCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pentery_completed);
        ...
        newSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nsintent = new Intent(PEnteryCompletedActivity.this, PEActivity.class);
        ...
        homeSuvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent dintent = new Intent(PEnteryCompletedActivity.this, SusCertDashboard.class);
