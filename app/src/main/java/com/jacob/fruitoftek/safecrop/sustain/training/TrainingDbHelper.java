...
public class TrainingDbHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_TRAINING_QUESTION1 = "training_question1";
    private static final String COLUMN_TRAINING_QUESTION2 = "training_question2";
    private static final String COLUMN_TRAINING_QUESTION3 = "training_question3";
    private static final String COLUMN_TRAINING_QUESTION4 = "training_question4";
    private static final String COLUMN_TRAINING_QUESTION5 = "training_question5";
    private static final String COLUMN_TRAINING_QUESTION6 = "training_question6";
    private static final String COLUMN_TRAINING_QUESTION7 = "training_question7";
    private static final String COLUMN_TRAINING_QUESTION8 = "training_question8";
    private static final String COLUMN_TRAINING_QUESTION9 = "training_question9";
    private static final String COLUMN_TRAINING_QUESTION10 = "training_question10";
    private static final String COLUMN_TRAINING_QUESTION11 = "training_question11";
    private static final String COLUMN_TRAINING_QUESTION12 = "training_question12";
    private static final String COLUMN_TRAINING_QUESTION13 = "training_question13";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " ("
                ...
                + COLUMN_TRAINING_QUESTION1 + " TEXT,"
                + COLUMN_TRAINING_QUESTION2 + " TEXT,"
                + COLUMN_TRAINING_QUESTION3 + " TEXT,"
                + COLUMN_TRAINING_QUESTION4 + " TEXT,"
                + COLUMN_TRAINING_QUESTION5 + " TEXT,"
                + COLUMN_TRAINING_QUESTION6 + " TEXT,"
                + COLUMN_TRAINING_QUESTION7 + " TEXT,"
                + COLUMN_TRAINING_QUESTION8 + " TEXT,"
                + COLUMN_TRAINING_QUESTION9 + " TEXT,"
                + COLUMN_TRAINING_QUESTION10 + " TEXT,"
                + COLUMN_TRAINING_QUESTION11 + " TEXT,"
                + COLUMN_TRAINING_QUESTION12 + " TEXT,"
                + COLUMN_TRAINING_QUESTION13 + " TEXT,"
    ...
    public boolean insertOrUpdateTraining(String training_code, String district, String community,
        ...
        values.put(COLUMN_TRAINING_QUESTION1, training_question1);
        values.put(COLUMN_TRAINING_QUESTION2, training_question2);
        values.put(COLUMN_TRAINING_QUESTION3, training_question3);
        values.put(COLUMN_TRAINING_QUESTION4, training_question4);
        values.put(COLUMN_TRAINING_QUESTION5, training_question5);
        values.put(COLUMN_TRAINING_QUESTION6, training_question6);
        values.put(COLUMN_TRAINING_QUESTION7, training_question7);
        values.put(COLUMN_TRAINING_QUESTION8, training_question8);
        values.put(COLUMN_TRAINING_QUESTION9, training_question9);
        values.put(COLUMN_TRAINING_QUESTION10, training_question10);
        values.put(COLUMN_TRAINING_QUESTION11, training_question11);
        values.put(COLUMN_TRAINING_QUESTION12, training_question12);
        values.put(COLUMN_TRAINING_QUESTION13, training_question13);
    ...
    public List<TrainingModel> getAllTraining() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                TrainingModel model = new TrainingModel( id, training_code,
                        district, community, training_question1, training_question2, training_question3,
    ...
    public TrainingModel getSurveyDetailsByTrainingName(String training_code) {
        SQLiteDatabase db = this.getReadableDatabase();
        TrainingModel inspectionModel = null;
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            inspectionModel = new TrainingModel(id, training_code, district, community, training_question1,
    ...
    public void markBatchAsSynced(List<TrainingModel> inspections) {
        SQLiteDatabase db = this.getWritableDatabase();
        for (TrainingModel inspection : inspections) {
            ContentValues values = new ContentValues();
            values.put("is_sync", "1");
            db.update("TrainingTbl", values, "training_code = ?", new String[]{inspection.getTraining_code()});
        }
        db.close();
    }
}
