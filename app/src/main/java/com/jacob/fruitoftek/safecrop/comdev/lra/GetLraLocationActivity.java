...
public class GetLraLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_lra_location);
        ...
        locationTextView = findViewById(R.id.lraLocationTextView);
        captureButton = findViewById(R.id.lraCaptureLocationButton);
        okButton = findViewById(R.id.lraOkButton);
        loadingIndicator = findViewById(R.id.lraLoadingIndicator);
