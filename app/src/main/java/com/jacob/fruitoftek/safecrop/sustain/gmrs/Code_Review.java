...
//        g. tvUserName2.setText(requireNotNull(preferenceHelper.getOName()));
//
//
...
//
//
//5. create GMRDbHelper and insert user_fname, user_oname, farmer_code, farmer_code, farmer_photo, tp_photo, signature, on_create and on_update
//
//
...
//        TextView tvUserName2 = findViewById(R.id.gmrUserONameTV);
//
//        // Set TextViews using PreferenceHelper
//        tvUserName.setText(requireNotNull(preferenceHelper.getFName()));
//        tvUserName2.setText(requireNotNull(preferenceHelper.getOName()));
//
