...
public class GetComLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_com_location);
        ...
        locationTextView = findViewById(R.id.comLocationTextView);
        captureButton = findViewById(R.id.comCaptureSchLocationButton);
        okButton = findViewById(R.id.comOkButton);
        loadingIndicator = findViewById(R.id.comLoadingIndicator);
    ...
    private void initializeMap() {
        mapView = findViewById(R.id.comMapView);
        if (mapView == null) {
