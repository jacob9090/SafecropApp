...
public class GetInspectionLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_inspection_location);
        ...
        locationTextView = findViewById(R.id.inspectionLocationTextView);
        captureButton = findViewById(R.id.inspectionCaptureSchLocationButton);
        okButton = findViewById(R.id.inspectionOkButton);
        loadingIndicator = findViewById(R.id.inspectionLoadingIndicator);
    ...
    private void initializeMap() {
        mapView = findViewById(R.id.inspectionMapView);
        if (mapView == null) {
