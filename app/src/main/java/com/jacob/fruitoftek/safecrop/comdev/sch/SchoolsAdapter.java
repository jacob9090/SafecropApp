...
public class SchoolsAdapter extends RecyclerView.Adapter<SchoolsAdapter.SchoolViewHolder> {
    ...
    public SchoolsAdapter(Context context, List<SchoolModel> schoolList) {
    ...
    @NonNull
    @Override
    public SchoolsAdapter.SchoolViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_school, parent, false);
        return new SchoolsAdapter.SchoolViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SchoolsAdapter.SchoolViewHolder holder, int position) {
