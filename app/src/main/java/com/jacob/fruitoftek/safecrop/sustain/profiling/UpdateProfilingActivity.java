...
public class UpdateProfilingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateSusProfilingWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                runOnUiThread(() -> {
                    updateSusProfilingWebView.evaluateJavascript("window.prefillInspection(" + getSavedDataJson() + ");", null);
                });
            }
        });
    ...
    public class WebAppInterface {
        ...
        @JavascriptInterface
        public void updateSusProfiling(String farmer_id, String farmer_name, String farmer_gender, String district,
            ...
            susProfilingModel.setFarmer_name(farmer_name);
            susProfilingModel.setFarmer_gender(farmer_gender);
            susProfilingModel.setDistrict(district);
            susProfilingModel.setCommunity(community);
            susProfilingModel.setFarmer_dob(farmer_dob);
            susProfilingModel.setGhana_card(ghana_card);
            ...
            susProfilingModel.setSuspro_question22(suspro_question22);
            susProfilingModel.setSuspro_question23(suspro_question23);
            susProfilingModel.setSuspro_question24(suspro_question24);
            susProfilingModel.setSuspro_question25(suspro_question25);
